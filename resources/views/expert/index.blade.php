    ...
    <div class="row justify-content-center">
        <div class="col-md-9">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <h3 class="text-info" style="display:inline-block">Your Expertise</h3>
                    <div class="text-right" style="display:inline-block;float:right">
                        <a href="{{route('ex_create')}}" class="btn btn-outline-success">Add More</a>
                    </div>
                    <hr>
                          ...
                          @endphp
                           @foreach ($data as $d)
                            <tr>
                                ...
                                <td>{{ $d->name}}</td>
                                <td>
                                    <a href="{{ url('ex_update/'.base64_encode($d->id)) }}" class="btn btn-outline-primary btn-sm">Edit</a>
                            ...
                            <tr>
                                <td colspan="5">
                                    <a href="{{ route('skills_create')}}" class="btn btn-block btn-success">Continue Next</a>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="5">
                                    <a href="{{route('certificate_index')}}" class="btn btn-block btn-primary">Back to Certificate Summery</a>
                                </td>
                            </tr>
                        </tbody>
                    </table>
