        ...
        <div class="col-md-9">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <hr>
                    <form action="{{route('ex_store')}}" method="post">
                        @csrf
                        <div class="form-group">
                            <div class="row no-gutters">
                                <div class="col-md-12">
                                    <label for="">Expertise : </label>
                                     <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" placeholder="Enter Company Name" value="{{ old('name') }}">
                                    @error('name')
